...
form.addEventListener("submit", (event) => {
    ...
    checkForEmptyFields(usernameInput, emailInput, passwordInput, confirmPasswordInput);
...
function checkEmail(emailInput) {
    if (!(0, isEmail_1.default)(emailInput.value))
        showErrorMessage(emailInput, "Email inválido.");
}
function checkEqualPasswords(passwordInput, confirmPasswordInput) {
